...
VALUES (0, 'admin1@example.com', 'Alice', 'Admin', '$2a$10$D9yp7eFvOnzj5ClX6K2ChOXKH8sHCz44MIRjqNEFTgi/r6cKSL/ze',
        '1234567890', 'admin1'),
       (0, 'admin2@example.com', 'Bob', 'Admin', '$2a$10$OR4geCm6lUjWRj7y5E5V4e2axddrZov0uJZyXQa/QF1C1FkNLxE8i',
        '1234567891', 'admin2'),
       (0, 'user1@example.com', 'John', 'Doe', '$2a$10$4M3ajijup3O9FL9kksM8z.SuWxDbIo8B7b.CQwN.KOyd/.HNY0I42', NULL,
        'user1'),
       (0, 'user2@example.com', 'Jane', 'Doe', '$2a$10$rbAd8qBRDxfyaWbHyvCZMeobZ.L9TF9asPbhXy0IoZG0YSlxDROcW', NULL,
        'user2'),
       (0, 'user3@example.com', 'Jim', 'Beam', '$2a$10$e/N7R9Iz3VpTLH.o9wqZoex5TYFSZDPkC82k9kPE/9SZeBPGUVwLG', NULL,
        'user3'),
       (0, 'user4@example.com', 'Jack', 'Daniels', '$2a$10$sqmeu1SDjKTeNG0Z67m.I.RFvc/WHzzyoqzwjBBkU6DKT1h2B02Re', NULL,
        'user4'),
       (0, 'user5@example.com', 'Johnny', 'Walker', '$2a$10$HQcyOi.KDN9GKgcuAUnl7eomMT5BoBh6F9HlsMlItE6kDA1OnSoFu',
        NULL, 'user5'),
       (0, 'user6@example.com', 'Tom', 'Cruise', '$2a$10$ZfUB5Hba.9t6sE.CWzFP5eFnlk64OB8YQbCnF/qyFeXkSxzUo7bsG', NULL,
        'user6'),
       (0, 'user7@example.com', 'Scarlett', 'Johansson', '$2a$10$ZaylfvT6o9hvsXleoyUoMeWsd53EudYJbhc4jv/rIAP6woIvQe1uK',
        NULL, 'user7'),
       (0, 'user8@example.com', 'Chris', 'Evans', '$2a$10$yjj5BjO9G1kDBmyOXw37luItkWbs2S/V8efH5Ns4JrO.xYsp/5siS', NULL,
        'user8'),
       (0, 'user9@example.com', 'Robert', 'Downey', '$2a$10$ZfUB5Hba.9t6sE.CWzFP5eFnlk64OB8YQbCnF/qyFeXkSxzUo7bsG',
        NULL, 'user9'),
       (0, 'user10@example.com', 'Mark', 'Ruffalo', '$2a$10$yjj5BjO9G1kDBmyOXw37luItkWbs2S/V8efH5Ns4JrO.xYsp/5siS',
        NULL, 'user10');
